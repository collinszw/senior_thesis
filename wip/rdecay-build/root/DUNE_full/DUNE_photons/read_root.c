{
  ...
  TH2F *electron_efficiency_hist = new TH2F("electron_efficiency_hist","DUNE photon efficiency", 56, 0, 56, 56, 0, 56);
  ...
  electron_efficiency_hist->SetTitle("Photon efficiency");
