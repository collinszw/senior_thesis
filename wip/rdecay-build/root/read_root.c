{
  ...
  TH1F *electron_ar_e_hist = new TH1F("electron_ar_e_hist", "Deposited electron energy for an event", 56,0,56);
  TH1F *neutron_ar_e_hist = new TH1F("neutron_ar_e_hist", "Deposited electron and neutron energy for an event", 56,0,56);
  TH1F *proton_ar_e_hist = new TH1F("proton_ar_e_hist", "Deposited electron, neutron, and proton energy for an event", 56,0,56);
  TH1F *photon_ar_e_hist = new TH1F("photon_ar_e_hist", "Deposited electron, neutron, proton, and photon energy for an event", 56,0,56);
  TH1F *neutron_count_hist = new TH1F("neutron_count_hist", "Adjustment of total energy spectrum for neutron seperation energy", 56,0,56);
  TH1F *proton_count_hist = new TH1F("proton_count_hist", "Adjustment of total energy spectrum for proton seperation energy", 56,0,56);
